cd "C:\Users\Albakassova_Maira\Desktop\Assignment"
clear all
set more off, perm
capture log close
...
cap mkdir temp
cap mkdir scripts
cap mkdir scripts/chunks 

*importing the dataset
import delimited "airbnb_london_listing.csv", clear

*creating a separate do file for the rest of the tasks for this assignment 
do scripts/chunks/work_coding_chunks.do 
